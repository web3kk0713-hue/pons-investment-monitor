...
const snapshot = {
  ...
  market: {
    ...
    depth2PctUsd: Number.isFinite(spotDepth.totalUsd) && Number.isFinite(perpDepth.totalUsd) ? spotDepth.totalUsd + perpDepth.totalUsd : null,
    observedDepth2PctUsd: Number.isFinite(spotDepth.totalUsd) || Number.isFinite(perpDepth.totalUsd) ? (spotDepth.totalUsd ?? 0) + (perpDepth.totalUsd ?? 0) : null,
    depthCoverage: Number.isFinite(spotDepth.totalUsd) && Number.isFinite(perpDepth.totalUsd) ? 'spot_and_perp' : Number.isFinite(spotDepth.totalUsd) ? 'spot_only' : Number.isFinite(perpDepth.totalUsd) ? 'perp_only' : 'missing',
    dexLiquidityUsd,
    dexVolume24hUsd,
